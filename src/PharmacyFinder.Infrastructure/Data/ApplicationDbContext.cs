    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        private void ConfigureEntities(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<MedicineStock>(entity =>
            {
                ...
                entity.HasIndex(ms => new { ms.PharmacyId, ms.MedicineId })
                      .IsUnique()
                      .HasDatabaseName("IX_MedicineStock_Pharmacy_Medicine");
            ...
            modelBuilder.Entity<OperatingHour>(entity =>
            {
                ...
                entity.HasIndex(oh => new { oh.PharmacyId, oh.DayOfWeek })
                      .IsUnique()
                      .HasDatabaseName("IX_OperatingHours_Pharmacy_Day");
            });
